      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              { icon: <MapPin className="w-5 h-5 text-blue-600 mt-1" />, title: "Adresse", content: venue.location },
              { icon: <Phone className="w-5 h-5 text-blue-600 mt-1" />, title: "Téléphone", content: venue.phone },
              { icon: <Clock className="w-5 h-5 text-blue-600 mt-1" />, title: "Horaires", content: venue.hours },
              { icon: <DollarSign className="w-5 h-5 text-blue-600 mt-1" />, title: "Prix", content: venue.price },
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 20 }}
          ...
          <motion.div
            ...
            whileHover={{ scale: 1.05 }}
          >
            <Button className="w-full py-6 text-lg bg-[#ea3e4e] hover:bg-[#37b7ab] transition-colors duration-300">
              Réserver Maintenant
            </Button>
          </motion.div>
        </div>
