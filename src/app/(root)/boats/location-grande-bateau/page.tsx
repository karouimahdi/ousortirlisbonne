  ...
  const boats = [
    {
      ...
      description:
        "Notre meilleure offre pour réunir amis, famille et collègue pour une croisière privée à moindre coût.",
      badge: "Économique",
      prices: [
    ...
    },
    {
      ...
      description:
        "Un yacht spacieux et élégant parfait pour les événements professionnels et les célébrations luxueuses.",
      badge: "Premium",
      prices: [
    ...
    },
    {
      ...
      description:
        "Notre plus grand bateau pour vos événements d'entreprise, mariages et grandes célébrations.",
      badge: "Événements",
      prices: [
    ...
    },
    {
      ...
      description:
        "Une expérience intime et luxueuse pour les petits groupes désirant une navigation traditionnelle.",
      badge: "Luxe",
      prices: [
