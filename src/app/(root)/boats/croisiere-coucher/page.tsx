        ...
        >
          <div className="space-y-6 text-white">
            <p className="text-lg leading-relaxed">
              Installé confortablement à bord de votre embarcation, un verre à
              la main, découvrez quelques-uns des monuments les plus
              emblématiques de la capitale, de cet angle si particulier qu'offre
              le fleuve.
            </p>
            ...
            <div className="flex flex-col md:flex-row gap-4 mt-8">
              ...
              >
                ...
                <span className="text-sm">
                  Tarif réduit -10 ans, Gratuit -2 ans
                </span>
              </motion.div>
              <motion.div
                whileHover={{ scale: 1.02 }}
...
export default function CroisierCoucherPage() {
  const boats = [
    ...
    },
    {
      ...
      departure: "Départ de Belém",
      images: ["/c*atamaran.jpg", "/catamaran2.jpg", "/catamaran1.jpg"],
    },
  ];
