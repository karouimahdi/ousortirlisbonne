...
const SetubalPage = () => {
  const motorBoats = [
    {
      images: [
        "/Kelt-Azura-Bateau-a-moteur-min.jpg",
        "/Kelt-Azura-Bateau-a-moteur-2-min.jpg",
      ],
      title: "Kelt Azura",
  ...
  const sailBoats = [
    {
      images: [
        "/Voilier-8-personnes-Arrabida-Setubal-min.jpg",
        "/Voilier-8-personnes-Setubal-_-Arrabida-2-min.jpg",
      ],
      title: "Attalia 32",
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <p className="text-gray-600 leading-relaxed">
              Découvrez la Serra de Arrabida à bord de nos bateaux équipés,
              entre paysages époustouflants et rencontres marines inoubliables.
            </p>
              ...
              <div className="p-6">
                ...
                <div className="flex gap-4 mb-6">
                  {boat.prices.map((price, i) => (
                    <div
                      key={i}
                      className="flex-1 p-3 bg-[#f8fafc] rounded-lg text-center"
                    >
                      <div className="text-lg font-bold text-[#2a2765]">
                        {price.price}
                      </div>
                      <div className="text-sm text-gray-600">
                        {price.duration}
