...
const HeroBanner = () => {
  ...
  const features = [
    { icon: Sun, text: translations["sunsetFeature"] },
    { icon: Coffee, text: translations["onboardServiceFeature"] },
    { icon: Waves, text: translations["uniqueExperienceFeature"] },
  ];
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-24">
        ...
        >
          <Badge className="mb-6 bg-[#37b7ab]/20 text-white hover:bg-[#37b7ab]/30">
            {translations["uniqueExperienceBadge"]}
          </Badge>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 text-white">
            {translations["heroTitleC"]}
            <span className="text-[#37b7ab]">{translations["heroHighlight"]}</span>
          </h1>
          <p className="text-xl text-white/90 mb-8">
            {translations["startingFromText"]}{" "}
        ...
        >
          <div className="space-y-6 text-white">
            <p className="text-lg leading-relaxed">
              {translations["heroDescriptionC"]}
            </p>
            <div className="grid grid-cols-2 gap-4">
              {[
                translations["cristoRei"],
                translations["ponte25Abril"],
                translations["torreDeBelem"],
                translations["maat"],
                translations["pracaDoComercio"],
                translations["padraoDosDescobrimentos"],
              ].map((monument) => (
                <motion.div
                  key={monument}
                  whileHover={{ x: 5 }}
            ...
            <div className="flex flex-col md:flex-row gap-4 mt-8">
              ...
              >
                ...
                <span>{translations["drinkIncludedText"]}</span>
              </motion.div>
            </div>
          </div>
        </motion.div>
    ...
    >
      ...
      <div className="p-8">
        <Badge className="mb-4 bg-[#2a2765]/10 text-[#2a2765] hover:bg-[#2a2765]/20">
          {isBestSeller ? translations["bestSeller"] : translations["new"]}
        </Badge>
        ...
        <div className="mt-6 flex justify-between items-center">
          <div>
            <p className="text-sm text-gray-500">{translations["startingFromText"]}</p>
...
export default function CroisierCoucherPage() {
    ...
    async () => {
      try {
        ...
        return boats.map((boat: any) => ({
          title: boat.title || translations["untitledCruise"],
          price: boat.prices || translations["priceNotAvailable"],
          time: boat.duration || translations["durationNotSpecified"],
          capacity: boat.capacity || translations["capacityNotSpecified"],
          departure: boat.départ || translations["departureNotSet"],
        ...
        throw new Error(translations["failedToLoadSunsetCruises"]);
      }
    },
    {
  ...
  if (boatError) return <div>{translations["errorLoadingBoats"]}</div>;
  if (boatLoading) return <div>{translations["loading"]}</div>;
      ...
      <section className="max-w-7xl mx-auto px-4 py-24">
        ...
        >
          ...
          <h2 className="text-4xl font-bold text-[#2a2765] mb-4">
            {translations["chooseYourAdventureTitle"]}
          </h2>
