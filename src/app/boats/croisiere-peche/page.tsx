...
import { Anchor, Fish, Sun, Waves, MapPin, Clock, Users, Sailboat, Compass, Timer } from 'lucide-react';
          ...
          <div className="absolute top-4 left-4 flex gap-2 items-start">
            ...
            <div className="bg-white/90 px-3 py-1 rounded-full backdrop-blur-sm">
              <span className="text-[#2a2765] font-bold text-lg">
                {prices[0].price} 
                <span className="text-sm text-gray-600 ml-1">/ {prices[0].duration}</span>
              </span>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-7xl mx-auto px-4 py-24">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <img src="/Tokyo.jpeg" alt="Cascais" className="rounded-xl h-64 object-cover" />
            <img src="/yacht.jpg" alt="Marina" className="rounded-xl h-64 object-cover" />
            <img src="/voilier.jpg" alt="Plage" className="rounded-xl h-64 object-cover col-span-2" />
          </div>
        </div>
      </section>
